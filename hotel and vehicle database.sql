...
INSERT INTO `customer` (`cust_id`, `name`, `location`, `no_of_people`, `gender`, `phone`, `occupation`, `room_id`, `no_of_days`) VALUES
(2, 'sachin', 'mysore', 2, 'm', '8785054', 'student', 'S-203', 2);
...
INSERT INTO `room_booking_details` (`book_id`, `discount_id`, `amount`, `name`, `id_proof`, `date`, `cust_id`, `room_id`) VALUES
(2, 'D11', '12600', 'sachin', 'passport', 'Wed Dec 13 10:52:35 IST 2017', 2, 'S-203');
...
('HATCHBACK', 'SWIFT', '8', 'ÝES', 'KA-01-S-1658', '2000'),
...
--
ALTER TABLE `customer`
  MODIFY `cust_id` float NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `room_booking_details`
  MODIFY `book_id` float NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
